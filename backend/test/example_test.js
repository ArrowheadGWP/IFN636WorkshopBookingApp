...
const { updateTask,getTasks,addTask,deleteTask } =
require('../controllers/taskController');
const { expect } = chai;



describe('Signup User Profile Function Test', () => {

  it('should Signup User profile successfully', async () => {
    // Mock request data
  ...
  it('should return 404 if User Profile Form info is not found', async () => {
...
describe('Add Workshop booking Function Test', () => {

  it('should create a new Workshop Booking successfully', async () => {
    // Mock request data
    const req = {
      user: { id: new mongoose.Types.ObjectId() },
      body: { title: "New Booking", description: "Task description", deadline: "2025-12-31" }
    };
...
describe('Update Workshop booking Test', () => {

  it('should update workshop booking successfully', async () => {
    // Mock task data
...
describe('Display Workshop Times Function Test', () => {

  it('should Display workshop Bookings for the given user', async () => {
    // Mock user ID
    const userId = new mongoose.Types.ObjectId();
...
describe('Add New User Function Test', () => {

  it('should Add New User profile successfully', async () => {
    // Mock request data
    const req = { params: { id: new mongoose.Types.ObjectId().toString() } };
...
describe('Retrieve User Profile Function Test', () => {
...
describe('Update User Profile Function Test', () => {
